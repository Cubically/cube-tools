...
imagefill($im, $scalepx*85,  25*$scalepx,  $colors[substr($stickers, 0,  1)]);  // UBL sticker
imagefill($im, $scalepx*123, 30*$scalepx,  $colors[substr($stickers, 1,  1)]);  // UB sticker
imagefill($im, $scalepx*158, 32*$scalepx,  $colors[substr($stickers, 2,  1)]);  // UBR sticker
imagefill($im, $scalepx*71,  40*$scalepx,  $colors[substr($stickers, 3,  1)]);  // UL sticker
imagefill($im, $scalepx*101, 40*$scalepx,  $colors[substr($stickers, 4,  1)]);  // U sticker
imagefill($im, $scalepx*143, 46*$scalepx,  $colors[substr($stickers, 5,  1)]);  // UR sticker
imagefill($im, $scalepx*43,  56*$scalepx,  $colors[substr($stickers, 6,  1)]);  // UFL sticker
imagefill($im, $scalepx*88,  57*$scalepx,  $colors[substr($stickers, 7,  1)]);  // UF sticker
imagefill($im, $scalepx*121, 63*$scalepx,  $colors[substr($stickers, 8,  1)]);  // UFR sticker
imagefill($im, $scalepx*35,  91*$scalepx,  $colors[substr($stickers, 9,  1)]);  // FLU sticker
imagefill($im, $scalepx*78,  91*$scalepx,  $colors[substr($stickers, 10, 1)]);  // FU sticker
imagefill($im, $scalepx*120, 91*$scalepx,  $colors[substr($stickers, 11, 1)]);  // FRU sticker
imagefill($im, $scalepx*40,  135*$scalepx, $colors[substr($stickers, 12, 1)]);  // FL sticker
imagefill($im, $scalepx*80,  135*$scalepx, $colors[substr($stickers, 13, 1)]);  // F sticker
imagefill($im, $scalepx*120, 135*$scalepx, $colors[substr($stickers, 14, 1)]);  // FR sticker
imagefill($im, $scalepx*50,  170*$scalepx, $colors[substr($stickers, 15, 1)]);  // FDL sticker
imagefill($im, $scalepx*90,  170*$scalepx, $colors[substr($stickers, 16, 1)]);  // FD sticker
imagefill($im, $scalepx*146, 87*$scalepx,  $colors[substr($stickers, 18, 1)]);  // RUF sticker
imagefill($im, $scalepx*162, 68*$scalepx,  $colors[substr($stickers, 19, 1)]);  // RU sticker
imagefill($im, $scalepx*177, 51*$scalepx,  $colors[substr($stickers, 20, 1)]);  // RUB sticker
imagefill($im, $scalepx*150, 130*$scalepx, $colors[substr($stickers, 21, 1)]);  // RF sticker
imagefill($im, $scalepx*160, 110*$scalepx, $colors[substr($stickers, 22, 1)]);  // R sticker
imagefill($im, $scalepx*180, 95*$scalepx,  $colors[substr($stickers, 23, 1)]);  // RB sticker
imagefill($im, $scalepx*150, 170*$scalepx, $colors[substr($stickers, 24, 1)]);  // RFD sticker
imagefill($im, $scalepx*160, 145*$scalepx, $colors[substr($stickers, 25, 1)]);  // RD sticker
imagefill($im, $scalepx*180, 130*$scalepx, $colors[substr($stickers, 26, 1)]);  // RFD sticker
